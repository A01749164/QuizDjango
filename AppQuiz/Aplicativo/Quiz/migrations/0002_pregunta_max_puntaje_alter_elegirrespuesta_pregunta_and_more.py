    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quizUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Quiz.quizusuario')),
                ('respuesa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='intentos', to='Quiz.elegirrespuesta')),
            ],
        ),
    ]
